...
import 'package:budget_tracker_ui_clone/model/expense_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Expense",style: TextStyle( color:Colors.black,fontSize: 20,
                        ...
                        return Container(
                          ...
                          child: Card(
                            ...
                            child: Column(
                              children: [
                                ListTile(
                                  title: Text(expense[index]['name'],style: TextStyle(color: white.withOpacity(0.8),)),
                                  subtitle: Text(expense[index]['price'],style: TextStyle(color: white,
                                      fontSize: 25,fontWeight: FontWeight.bold ),),
                                  trailing: Image.asset(expense[index]['image'],),
                                ),
                                Expanded(
                                  flex: 0,
                                  child: Padding(
